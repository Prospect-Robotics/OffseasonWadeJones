...
public enum AutoRoutine {
    ...
    // Tests and Chezy-only auto routines (Chezy-only because they allowed 2-ball
    // preload, while the standard by
    // the game manual is 1-ball preload).
    // TWO_BALL_BASIC("2-ball Basic", new SequentialCommandGroup(
    // new InstantCommand(() ->
    // ROBOT_CONTAINER.getShooter().setFlywheelRPM(DEFAULT_SHOOT_DEMAND),
    ...
    // new AutoShootCommand(ROBOT_CONTAINER.getDrive(),
    // ROBOT_CONTAINER.getMagazine(), ROBOT_CONTAINER.getShooter())
    // )),
    ...
    // ROBOT_CONTAINER.getShooter().setFlywheelRPM(DEFAULT_SHOOT_DEMAND),
    // ROBOT_CONTAINER.getShooter()),
    // new AutoInitDriveCommand("ThreeBall_Basic_TarmacShoot",
    ...
    // new AutoIntakeCommand(ROBOT_CONTAINER.getIntake(),
    // ROBOT_CONTAINER.getMagazine()),
    // new FollowCommand("ThreeBall_Basic_IntakeThenShoot",
    // ROBOT_CONTAINER.getDrive()),
    // new AutoStopIntakeCommand(ROBOT_CONTAINER.getIntake(),
    // ROBOT_CONTAINER.getMagazine()),
    // new AutoShootCommand(ROBOT_CONTAINER.getDrive(),
    // ROBOT_CONTAINER.getMagazine(), ROBOT_CONTAINER.getShooter())
    // )),
    ...
    // ROBOT_CONTAINER.getShooter().setFlywheelRPM(DEFAULT_SHOOT_DEMAND),
    // ROBOT_CONTAINER.getShooter()),
    // new AutoInitDriveCommand("ThreeBall_Intake_TarmacShoot", true,
    // ROBOT_CONTAINER.getDrive()),
    // new FollowCommand("ThreeBall_Intake_TarmacShoot", true,
    // ROBOT_CONTAINER.getDrive()),
    // new AutoShootCommand(ROBOT_CONTAINER.getDrive(),
    // ROBOT_CONTAINER.getMagazine(), ROBOT_CONTAINER.getShooter()),
    // new RotateCommand(135, ROBOT_CONTAINER.getDrive()),
    // new AutoIntakeCommand(ROBOT_CONTAINER.getIntake(),
    // ROBOT_CONTAINER.getMagazine()),
    // new FollowCommand("ThreeBall_Intake_IntakeThenShoot",
    // ROBOT_CONTAINER.getDrive()),
    // new AutoStopIntakeCommand(ROBOT_CONTAINER.getIntake(),
    // ROBOT_CONTAINER.getMagazine()),
    // new AutoShootCommand(ROBOT_CONTAINER.getDrive(),
    ...
    // new AutoIntakeCommand(ROBOT_CONTAINER.getIntake(),
    // ROBOT_CONTAINER.getMagazine()),
    // new FollowCommand("ThreeBall_Intake_IntakeOpponentBall",
    // ROBOT_CONTAINER.getDrive()),
    // new WaitCommand(1),
    // new AutoStopIntakeCommand(ROBOT_CONTAINER.getIntake(),
    // ROBOT_CONTAINER.getMagazine())
    ...
    // new AutoIntakeCommand(ROBOT_CONTAINER.getIntake(),
    // ROBOT_CONTAINER.getMagazine()),
    // new FollowCommand("FourBall_Basic_IntakeThenShoot",
    // ROBOT_CONTAINER.getDrive()),
    // new AutoStopIntakeCommand(ROBOT_CONTAINER.getIntake(),
    // ROBOT_CONTAINER.getMagazine()),
    // new AutoShootCommand(ROBOT_CONTAINER.getDrive(),
    ...
    // ROBOT_CONTAINER.getShooter().setFlywheelRPM(DEFAULT_SHOOT_DEMAND),
    // ROBOT_CONTAINER.getShooter()),
    // new AutoInitDriveCommand("FourBall_Reversed_TarmacShoot", true,
    // ROBOT_CONTAINER.getDrive()),
    // new FollowCommand("FourBall_Reversed_TarmacShoot", true,
    // ROBOT_CONTAINER.getDrive()),
    // new AutoShootCommand(ROBOT_CONTAINER.getDrive(),
    // ROBOT_CONTAINER.getMagazine(), ROBOT_CONTAINER.getShooter()),
    // new RotateCommand(180, ROBOT_CONTAINER.getDrive()),
    // new AutoIntakeCommand(ROBOT_CONTAINER.getIntake(),
    // ROBOT_CONTAINER.getMagazine()),
    // new FollowCommand("FourBall_Reversed_IntakeThenShoot",
    // ROBOT_CONTAINER.getDrive()),
    // new AutoStopIntakeCommand(ROBOT_CONTAINER.getIntake(),
    // ROBOT_CONTAINER.getMagazine()),
    // new AutoShootCommand(ROBOT_CONTAINER.getDrive(),
    ...
    // ROBOT_CONTAINER.getMagazine(), ROBOT_CONTAINER.getShooter())
    // )),
    // ROTATE_90_TEST("Rotate 90 Test", new RotateCommand(90,
    // ROBOT_CONTAINER.getDrive())),
    // ROTATE_180_TEST("Rotate 180 Test", new RotateCommand(180,
    // ROBOT_CONTAINER.getDrive())),
    ...
    TWO_BALL("2-Ball", new SequentialCommandGroup(
            ...
            new AutoStopIntakeCommand(ROBOT_CONTAINER.getIntake(), ROBOT_CONTAINER.getMagazine()),
            new RotateCommand(180, ROBOT_CONTAINER.getDrive()),
            new AutoShootCommand(ROBOT_CONTAINER.getDrive(), ROBOT_CONTAINER.getMagazine(),
                    ROBOT_CONTAINER.getShooter()))),

    X_Ball("X-Ball", new SequentialCommandGroup(
            new InstantCommand(() -> ROBOT_CONTAINER.getShooter().setFlywheelRPM(DEFAULT_SHOOT_DEMAND),
                    ROBOT_CONTAINER.getShooter()),
            new AutoInitDriveCommand("Vineet_Test", ROBOT_CONTAINER.getDrive()),
            new AutoIntakeCommand(ROBOT_CONTAINER.getIntake(), ROBOT_CONTAINER.getMagazine()),
            new FollowCommand("Vineet_Test", ROBOT_CONTAINER.getDrive()),
            new AutoStopIntakeCommand(ROBOT_CONTAINER.getIntake(), ROBOT_CONTAINER.getMagazine())));
